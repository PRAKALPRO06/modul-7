...
// Struct Titik merepresentasikan sebuah titik dengan koordinat x dan y
type Titik struct {
	x, y int
}

// Struct Lingkaran merepresentasikan lingkaran dengan pusat dan radius
...
// Fungsi diDalam memeriksa apakah sebuah titik berada di dalam lingkaran
